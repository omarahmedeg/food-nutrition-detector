...
│   ├── nutrition_data_food101.py # Nutrition database
│   ├── pytorch_model.py       # PyTorch model wrapper
│   ├── requirements.txt       # Python dependencies
│   ├── data/                  # Dataset folder
│   │   ├── train/
│   │   └── validation/
│   └── saved_models/          # Trained models (.pth)
│
...
```bash
# Install Python dependencies (from root folder)
...
```bash
# Start Flask API server (from root folder)
...
2. Add nutrition info to `ml-model/nutrition_data_food101.py`:
